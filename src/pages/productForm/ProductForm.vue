  ...
  <div class="checkout">
    ...
    <form @submit.prevent="save">
      <div class="form-group">
        ...
        <input type="text" v-model="form.name" id="card-number" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" v-model="form.price" id="cvv-code" required />
      </div>
      <div class="form-group">
        <label for="cvv-code">Descrição do produto</label>
        <input type="text" v-model="form.description" id="cvv-code" required />
      </div>
